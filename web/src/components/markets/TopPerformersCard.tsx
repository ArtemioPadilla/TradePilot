 ...
 *
 * Displays top performing assets by period with quick actions.
 */
...
export default function TopPerformersCard({
  ...
  return (
    <div className="performers-card top-performers">
      <div className="card-header">
        <div className="header-left">
          <TrendingUp className="header-icon positive" size={20} />
